...
const COMPANIES_METADATA = [
  ...
  { symbol: 'TMPV',     name: 'Tata Motors Passenger Vehicles', sector: 'Automobile', industry: 'Passenger Vehicles', color: '#1d4ed8', basePrice: 450.0 },
  ...
  { symbol: 'BAJAJ-AUTO',name: 'Bajaj Auto Ltd', sector: 'Automobile', industry: 'Two & Three Wheelers', color: '#1d4ed8', basePrice: 9400.0 },
  ...
  { symbol: 'TRENT',    name: 'Trent Ltd', sector: 'Consumer Services', industry: 'Retail & Apparel', color: '#4b5563', basePrice: 4700.0 },
  { symbol: 'MAXHEALTH',name: 'Max Healthcare Institute', sector: 'Healthcare', industry: 'Hospitals', color: '#991b1b', basePrice: 850.0 },
  { symbol: 'INDIGO',   name: 'InterGlobe Aviation Ltd', sector: 'Consumer Services', industry: 'Airlines', color: '#1e3a8a', basePrice: 4200.0 },
  { symbol: 'SHRIRAMFIN',name: 'Shriram Finance Ltd', sector: 'Banking & Financial', industry: 'NBFC', color: '#0284c7', basePrice: 2400.0 },
  { symbol: 'TATACONSUM',name: 'Tata Consumer Products Ltd', sector: 'FMCG', industry: 'Consumer Goods', color: '#0ea5e9', basePrice: 1150.0 },
  { symbol: 'HDFCLIFE', name: 'HDFC Life Insurance Co', sector: 'Banking & Financial', industry: 'Life Insurance', color: '#7c3aed', basePrice: 600.0 },
  { symbol: 'ETERNAL',  name: 'Eternal Limited', sector: 'Consumer Services', industry: 'Online Food Delivery', color: '#cb202d', basePrice: 250.0 },
];
